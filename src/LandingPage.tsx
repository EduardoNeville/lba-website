  ...
  return (
    <div className="relative top-0 grid grid-cols-1 gap-1 h-screen object-fill text-center text-primary md:text-right">
      <Transition
        ...
        className="z-[-1] md:opacity-100"
      >
        <img
          src="/images/puerto-banus-la-concha.jpeg"
          alt="la-Concha"
          className="relative h-100 md:h-full overflow-hidden"
        />
      </Transition>

      <div className="relative flex flex-col py-[2rem] md:w-[45rem] mx-[2rem] md:mx-auto">
        <div
          ref={ref}
          className= "static md:absolute md:inset-y-[6rem] md:-right-[10rem] text-center md:text-right"
        >
          <Transition
            show={inView}
